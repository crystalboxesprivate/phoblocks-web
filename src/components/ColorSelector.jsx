...
const ColorPicker = () => {
      ...
      <div style={{
        ...
        <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g filter="url(#pickerHandleDropShadow)">
            <circle cx="11" cy="10.5" r="8.5" stroke="white" stroke-width="2" />
          </g>
          <defs>
            <filter id="pickerHandleDropShadow" x="0.5" y="0" width="21" height="21" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
  ...
  return (
    <div style={{ position: 'absolute', top: 302, left: Theme.sidebarWidth -15, color: Theme.textBright0 }}>
      <div style={{ position: 'relative', top: 0, left: 0 }}>
        <div style={{
          ...
          <svg width="21" height="25" viewBox="0 0 21 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M14 0.5V3.5L2.5 13L14 22.5V25" stroke="#555555" stroke-width="2" />
          </svg>
        </div>
        <div style={{
          position: 'absolute',
          ...
          <div style={{ display: 'flex', ...Theme.getFont(14), alignItems: 'center', marginTop:27, marginRight: 4 }}>
            <div>
              <svg width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.5 1.5L5.5 5.5L1.5 9.5" stroke="#B9B9B9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
